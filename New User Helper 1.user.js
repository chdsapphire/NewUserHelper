...
(function() {
    ...
    $(document).ready(function() {
        var targetElem = $('a:contains("Chat")');
        targetElem.hover(function () {
            if (!buttonExists) {
                var btn = $('<button id="test-button">HELP</button>');
                btn.click(function() {
